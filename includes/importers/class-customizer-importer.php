...
class RT_Customizer_Importer {
	...
	public static function import( $import_file, $demo_id, $demo_data ) {
		...
		if ( isset( $data['options'] ) ) {
			...
			include_once dirname( __FILE__ ) . '/customize/class-one-click-customize-demo-importer-setting.php';

			foreach ( $data['options'] as $option_key => $option_value ) {
				$option = new RT_Customize_Demo_Importer_Setting( $wp_customize, $option_key, array(
					'default'    => '',
					'type'       => 'option',
