...
class SUIT_WXR_Parser {
	function parse( $file ) {
		...
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new RT_WXR_Parser_SimpleXML;
		...
		$parser = new RT_WXR_Parser_Regex;
