...
class RT_Widget_Importer {
	...
	public static function import( $import_file, $demo_id, $demo_data ) {
		...
		// Hook before import.
		do_action( 'evision_widget_importer_before_widgets_import' );
		$data = apply_filters( 'evision_before_widgets_import_data', $data );
		...
		foreach ( $data as $sidebar_id => $widgets ) {
			...
			foreach ( $widgets as $widget_instance_id => $widget ) {
				 ...
				 */
				$widget = apply_filters( 'evision_widget_demo_import_settings', $widget, $id_base, $instance_id_number, $demo_data, $demo_id );
				...
				if ( ! $fail ) {
					...
					do_action( 'evision_widget_importer_after_single_widget_import', $after_widget_import );
		...
		// Hook after import.
		do_action( 'evision_widget_importer_after_widgets_import' );

		// Return results.
		return apply_filters( 'evision_widget_import_results', $results );
	}
	...
	private static function available_widgets() {
		...
		return apply_filters( 'evision_widget_importer_available_widgets', $available_widgets );
	}
}
